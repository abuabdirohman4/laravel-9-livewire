                ...
                @foreach ($contacts as $contact)
                    <tr
                        ...
                        <td class="py-1 px-6">
                            ...
                            {{-- <button type="button" data-modal-toggle="popup-modal"
                                class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Flowbite</button> --}}
                            <label for="my-modal-{{ $contact->id }}"
                                class="modal-button text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Delete</label>
                            <!-- Modal Daisy UI -->
                            <input type="checkbox" id="my-modal-{{ $contact->id }}" class="modal-toggle" />
                            <div class="modal">
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <label for="my-modal-{{ $contact->id }}" wire:click="destroy({{ $contact->id }})"
